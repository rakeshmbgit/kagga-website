          ...
          <div className="bg-white rounded-xl shadow-sm border border-earth-200 p-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <p className="text-sm text-earth-600">{t('expertExplanations')}</p>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-earth-600">{t('detailedAnalysis')}</p>
                <p className="font-semibold text-earth-900">Coming Soon</p>
              </div>
                  <div className="text-center">
                ...
                <p className="text-sm text-earth-600">{t('interactiveLearning')}</p>
                <p className="font-semibold text-earth-900">Coming Soon</p>
              </div>
            </div>
